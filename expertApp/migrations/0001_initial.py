...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Expert',
            fields=[
                ('expertId', models.AutoField(default=0, primary_key=True, serialize=False)),
                ...
                ('approved', models.CharField(blank=True, choices=[('Y', 'Yes'), ('N', 'No')], default='N', max_length=1, null=True)),
